...
return [
    ...
    */
    ...
    # Login Page
    'Sign In' => 'Zaloguj',
    'Login to stay connected' => 'Zaloguj by się połączyć',
    'Email' => 'Email',
    'Password' => 'Hasło',
    'Remember Me' => 'Zapamiętaj mnie',
    'Forgot Password?' => 'Zapomniane hasło?',
    'or sign in with other accounts?' => 'lub zaloguj się innym kontem?',
    'Don’t have an account?' => 'Nie masz konta?',
    'Click here to sign up' => 'Kliknij tutaj, aby się zarejestrować',


    # Reset password
    'Forgot your password?' => 'Zapomniane hasło logowania?',
    'No problem' => 'Nie ma problemu. Po prostu podaj nam swój adres e-mail, a my wyślemy Ci link do zresetowania hasła, który pozwoli Ci ustawić nowe.',
    'Email Password Reset Link' => 'Łącze do resetowania hasła na e-mail',


    # Register Page
    'Sign Up' => 'Zarejestruj się',
    'Register to stay connected' => 'Zarejestruj by zostać połączonym',
    'Display Name' => 'Wyświetlana nazwa',
    'Confirm Password' => 'Potwierdź hasło',
    'Already have an account?' => 'Masz już konto?',
    'Click here to sign in' => 'Kliknij tutaj by się zalogować',


    # Pending verification by admin
    'Verification Status' => 'Status weryfikacji',
    'auth_pending' => 'Twoje konto nadal oczekuje na weryfikację',
    'auth_unverified' => 'Twoje konto jest obecnie niezweryfikowane i wymaga ręcznej weryfikacji przez administratora.',
    'Log out' => 'Wyloguj się',


    # Password confirmation
    'auth_password' => 'To jest zabezpieczony obszar aplikacji. Przed kontynuowaniem potwierdź swoje hasło.',
    'Confirm' => 'Potwierdź',


    # Password Reset
    'Reset Password' => 'Resetuj hasło',
    'Enter a new password' => 'Wpisz nowe hasło',


    # Test email
    'Test E-Mail' => 'Testowy E-Mail',
    ...
    'auth_thanks' => 'Dzięki za rejestrację! Zanim rozpoczniesz, zweryfikuj swój adres e-mail klikając w link który przysłaliśmy? Jeśli mail nie doszedł (sprawdź folder spam!), możemy wysłać kolejny. Jeśli nie dojdzie w kilka minut, koniecznie sprawdź folder ze spamem.',
    'auth_verification' => 'Nowy link weryfikacji własności skrzynki email został wysłany na adres podany podczas rejestracji.',
    'Resend Verification Email' => 'Wyślij email weryfikujący',
    ...
    */
    ...
    'Dark' => 'Ciemny',
    'Light' => 'Jasny',
    'Color Customizer' => 'Wybieracz kolorów',
    'Sidebar Color' => 'Kolor sidebara',
    'Default' => 'Domyślnie',
    'Color' => 'Kolor',
    'Transparent' => 'Przezroczystość',
    'Sidebar Types' => 'Typy sajdbara',
    'Mini' => 'Mini',
    'Hover' => 'Hover',
    'Boxed' => 'Boxed',
    'Sidebar Active Style' => 'Styl sajdbara',
    'Rounded One Side' => 'Zaokrąglona krawędź',
    'Rounded All' => 'Wszystkie zaokrąglone',
    'Pill One Side' => 'Pastylka jednostronna',
    'Pill All' => 'Pastylka dookoła',
    ...
    */
    ...
    'Admin' => 'Admin',
    'Config' => 'Konfiguracja',
    'Footer Pages' => 'Strony w stopce',
    'Site Customization' => 'Dostosowanie strony',
    ...
    'Site logo' => 'Logo strony',
    'Favicon' => 'Favicon',
    'Home message' => 'Komunikat na głównej',
    ...
    */
    ...
    'Share your profile' => 'Udostępnij profil',
    'Share your profile:' => 'Udostępnij profil:',
    'Error sharing:' => 'Błąd udostępniania:',
    'Text copied to clipboard!' => 'Tekst skopiowany!',
    'Error copying text:' => 'Błąd kopiowania tekstu:',
    'QR Code' => 'Kod QR',
    'Scan QR Code' => 'Skanuj kod QR',
    'QR code could not be generated' => 'Kod QR nie może zostać wygenerowany',
    'Reason:' => 'Powód:',
    ...
    'All Notifications' => 'Powiadomienia',

    # Updater dropdown
    'Updater' => 'Aktualizator',
    'Beta Mode' => 'Tryb bety',
    'Local version' => 'Lokalna wersja',
    'Latest beta' => 'Ustatnia beta',
    'Run updater' => 'Uruchom aktualizator',
    ...
    */
    ...
    'Set a handle' => 'Ustaw konto',

    # Dashboard Page
    'Total Links:' => 'Liczba linków:',
    'Link Clicks:' => 'Liczba kliknięć:',
    'View/Edit Links' => 'Pokaż/edytuj linki',
    'Top Links:' => 'Top linki:',
    'You haven’t added any links yet' => 'Jeszcze nie dodano linków.',
    'clicks' => 'kliki',
    'Clicks' => 'Kliki',
    'Site statistics:' => 'Statystyki strony:',
    'Total links' => 'Liczba linków',
    'Total clicks' => 'Kliknięcia linków',
    'Total users' => 'Liczba kont',
    'Registrations:' => 'Rejestracje:',
    'Last 30 days' => 'Ostatnie 30 dni',
    'Last 7 days' => 'Ostatnie 7 dni',
    'Last 24 hours' => 'Ostatnie 24 godziny',
    'Active users:' => 'Aktywne konta:',
    ...
    */
    ...
    'Toggle Dropdown' => 'Przełącz Dropdown',
    'Cancel' => 'Anuluj',
    'Save and Add More' => 'Zapisz i dodaj kolejny',
    'Click to change link blocks' => 'Kliknij by zmienić link blokowy',
    'Click for a list of available link blocks' => 'Kliknij by wyświetliś listę bloków',
    ...
    */
    ...
    'My Links' => 'Moje linki',
    'Add new Link' => 'Dodaj link',
    'No Link Added' => 'Jeszcze nie dodano linków.',
    'Download' => 'Pobierz',
    'Preview' => ' Podgląd:',
    'No compatible browser' => 'Twoja przeglądarka jest niekompatybilna',
    'Page Icons' => 'Ikonty strony',
    'Save links' => 'Zapisz linki',

    # Tooltips
    'Customize' => 'Dostosuj',
    'Delete' => 'Usuń',
    'Clear icon cache' => 'Wyczyść cache ikon',

    'confirm_delete' => 'Na pewno chcesz usunąć :title?',
    ...
    */
    ...
    'Profile Picture' => 'Obrazek profilowy',
    'Page URL' => 'Adres strony',
    'Display name' => 'Wyświetlana nazwa',
    'Name:' => 'Nazwa:',
    'Page Description' => 'Opis strony',
    'Show checkmark' => 'Wyświetl znacznik',
    'disableverified' => 'Masz zweryfikowane konto. To ustawienia pozawala ukryć znacznik..',
    'Show share button' => 'Pokaż udostępniacz',
    'disablesharebutton' => 'To ustawienie pozwala ukryć udostępniacz na twojej stronie.',
    'Open links in new tab' => 'Otwieraj linki w nowej karcie',
    'openlinksnewtab' => 'To ustawienia zmienia wyświetlanie linków w karcie obecnej lub nowej.',
    ...
    */
    ...
    'Export user data' => 'Eksport danych konta',
    'Export your user data' => 'Eksportuj dane konta, aby przenieść je do innej instancji.',
    'Export all data' => 'Eksport wszystkich danych',
    'Export links only' => 'Eksport jedynie linków',
    'Import user data' => 'Import danych konta',
    'import.user.alert' => 'Czy na pewno chcesz zaimportować ten plik? Ta czynność zastąpi wszystkie bieżące dane, w tym linki!',
    'Import your user data from another instance' => 'Import danych konta z innej instancji',
    'Import' => 'Import',
    'Delete your account' => 'Usuń twoje konto',
    'You are about to delete' => 'Zamirzasz usunąć twoje konto!',
    'You are about to delete This action cannot be undone' => 'Zamierzasz usunąć swoje konto! Tej czynności nie można cofnąć.',
    'Delete account' => 'Usuń konto',

    # Alerts
    'Profile updated successfully!' => 'Profil zaktualizowany pomyślnie!',
    'An error occurred while updating your profile.' => 'Błąd podczas aktualizacji profilu.',

    'That handle has already been taken' => 'Ta nazwa konta jest już zajęta.',
    'The selected file must be an image' => 'Wskazany plik musi być obrazem.',
    'The image must be' => 'Obraz musi być:',
    'The image size should not exceed 2MB' => 'Rozmiar obrazu nie może przekraczać 2MB.',
